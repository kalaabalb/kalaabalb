...
def render_handoff(mode: str = "dark", tokens: TokenBundle | None = None, config_path: Path | str = DEFAULT_HANDOFF_PATH) -> HandoffRender:
    ...
    svg = "".join(
        [
            ...
            _reveal_group(_selected_surface(theme, document.layout, selected), 140, motion.reveal, dy=8),
            _reveal_group(_threshold_shell(theme, document.layout, selected), 280, motion.reveal, dy=4),
